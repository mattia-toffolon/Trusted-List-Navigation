...
Moreover **only needed countries are parsed** in specific objects so the time and space complexity is reduced at the lowest level. It is important to note that a country with its complete data is **parsed** to specific objects **only the first time**, then is kept in case of future use.<br />
